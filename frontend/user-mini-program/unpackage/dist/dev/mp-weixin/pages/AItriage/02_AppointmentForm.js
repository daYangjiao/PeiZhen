...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const confirmAppointment = async () => {
      ...
      common_vendor.index.__f__("log", "at pages/AItriage/02_AppointmentForm.vue:516", "【02页面】即将发送的请求数据 (JSON.stringify):", JSON.stringify(demandData, null, 2));
      common_vendor.index.__f__("log", "at pages/AItriage/02_AppointmentForm.vue:517", "【02页面】即将发送的请求数据 (JS Object):", demandData);
      common_vendor.index.__f__("log", "at pages/AItriage/02_AppointmentForm.vue:520", "【02页面】字段类型检查:");
      common_vendor.index.__f__("log", "at pages/AItriage/02_AppointmentForm.vue:521", "  serviceTypeNumber:", typeof demandData.serviceTypeNumber, demandData.serviceTypeNumber);
      common_vendor.index.__f__("log", "at pages/AItriage/02_AppointmentForm.vue:522", "  serviceDate:", typeof demandData.serviceDate, demandData.serviceDate);
      common_vendor.index.__f__("log", "at pages/AItriage/02_AppointmentForm.vue:523", "  serviceStartTime:", typeof demandData.serviceStartTime, demandData.serviceStartTime);
      common_vendor.index.__f__("log", "at pages/AItriage/02_AppointmentForm.vue:524", "  serviceEndTime:", typeof demandData.serviceEndTime, demandData.serviceEndTime);
      common_vendor.index.__f__("log", "at pages/AItriage/02_AppointmentForm.vue:525", "  hospital:", typeof demandData.hospital, demandData.hospital);
      common_vendor.index.__f__("log", "at pages/AItriage/02_AppointmentForm.vue:526", "  patientName:", typeof demandData.patientName, demandData.patientName);
      common_vendor.index.__f__("log", "at pages/AItriage/02_AppointmentForm.vue:527", "  patientPhone:", typeof demandData.patientPhone, demandData.patientPhone);
      common_vendor.index.__f__("log", "at pages/AItriage/02_AppointmentForm.vue:528", "  otherRequirement:", typeof demandData.otherRequirement, demandData.otherRequirement);
      common_vendor.index.__f__("log", "at pages/AItriage/02_AppointmentForm.vue:529", "  symptoms:", typeof demandData.symptoms, demandData.symptoms, Array.isArray(demandData.symptoms));
      try {
        common_vendor.index.showLoading({ title: "提交中..." });
        const submitResponse = await utils_api.post("/ai/guide/appointments", demandData);
        common_vendor.index.__f__("log", "at pages/AItriage/02_AppointmentForm.vue:538", "【02页面】提交需求响应:", submitResponse);
        if (submitResponse && submitResponse.code === 200) {
          const appointmentNo = submitResponse.data.appointmentNo;
          common_vendor.index.__f__("log", "at pages/AItriage/02_AppointmentForm.vue:542", "【02页面】获取到预约编号:", appointmentNo);
          if (!appointmentNo) {
            throw new Error("未能获取到预约编号");
          }
          common_vendor.index.setStorageSync("appointmentNo", appointmentNo);
          common_vendor.index.navigateTo({
            url: "/pages/AItriage/03_AICareMatchPage?appointmentNo=" + appointmentNo
          });
        } else {
        ...
        common_vendor.index.__f__("error", "at pages/AItriage/02_AppointmentForm.vue:560", "【02页面】提交预约失败:", error);
        ...
        if (error.statusCode && error.data) {
          ...
          common_vendor.index.__f__("error", "at pages/AItriage/02_AppointmentForm.vue:565", "【02页面】API 响应详情:", error.data);
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        C: common_vendor.o(confirmAppointment),
        D: showTimeModal.value
      }, showTimeModal.value ? {
        E: common_vendor.t(timePickerTitle.value),
        F: common_vendor.o(hideTimePicker),
        G: common_vendor.f(timeOptions.value, (time, k0, i0) => {
          return {
        ...
        H: common_vendor.o(hideTimePicker),
        I: common_vendor.o(confirmTime),
        J: common_vendor.o(() => {
        }),
        K: common_vendor.o(hideTimePicker)
      } : {}, {
        L: showAddSymptomModalFlag.value
      }, showAddSymptomModalFlag.value ? common_vendor.e({
        M: common_vendor.o(hideAddSymptomModal),
        N: common_vendor.o(confirmAddSymptom),
        O: newSymptomInput.value,
        P: common_vendor.o(($event) => newSymptomInput.value = $event.detail.value),
        Q: newSymptomError.value
      }, newSymptomError.value ? {
        R: common_vendor.t(newSymptomError.value)
      } : {}, {
        S: common_vendor.o(hideAddSymptomModal),
        T: common_vendor.o(confirmAddSymptom),
        U: common_vendor.o(() => {
        }),
        V: common_vendor.o(hideAddSymptomModal)
      }) : {});
    };
  }
};
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-fb9ebbd2"]]);
wx.createPage(MiniProgramPage);
//# sourceMappingURL=../../../.sourcemap/mp-weixin/pages/AItriage/02_AppointmentForm.js.map
